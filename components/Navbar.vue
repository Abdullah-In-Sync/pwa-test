      ...
      <div class="max-w-7xl mx-auto flex justify-between items-center px-4 py-5 sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10">
        <div>
          <NuxtLink to="/" class="flex">
            ...
            <nuxt-img format="svg" class="h-8 w-auto sm:h-10" src="/logo.svg" alt="" />
          </NuxtLink>
        </div>
...
import { Popover, PopoverButton, PopoverGroup, PopoverPanel } from '@headlessui/vue'
  import BookmarkAltIcon from '@heroicons/vue/24/outline/BookmarkIcon'
  ...
  import CursorClickIcon from '@heroicons/vue/24/outline/CursorArrowRippleIcon'
  import DesktopComputerIcon from '@heroicons/vue/24/outline/ComputerDesktopIcon'
  ...
  import OfficeBuildingIcon from '@heroicons/vue/24/outline/BuildingOffice2Icon'
  ...
  import ViewGridIcon from '@heroicons/vue/24/outline/ViewColumnsIcon'
